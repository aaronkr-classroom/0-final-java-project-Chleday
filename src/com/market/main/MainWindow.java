...
public class MainWindow extends JFrame {
	...
	private void menuIntroduction() {
		...
		JButton bt2 = new JButton("장바구니 상품목록보기", new ImageIcon("./img/2.png"));
		...
		JButton bt4 = new JButton("장바구니에 항목추가하기", new ImageIcon("./img/4.png"));
		bt4.setFont(ft);
		mMenuPanel.add(bt4);
		...
		JButton bt5 = new JButton("장바구니에 항목수량 줄이기", new ImageIcon("./img/5.png"));
		bt5.setFont(ft);
		mMenuPanel.add(bt5);

		JButton bt6 = new JButton("장바구니에 항목삭제하기", new ImageIcon("./img/6.png"));
		bt6.setFont(ft);
		mMenuPanel.add(bt6);
