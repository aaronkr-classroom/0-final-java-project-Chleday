...
public class Welcome {
	...
	public static void main(String[] args) {
		...
		while(!quit) {
			...
			System.out.println("2. 장바구니 상품 목록보기 \t6. 장바구니에 항목 수량 줄이기");
...
//					System.out.println("이름 " + name + " 연락처: " + phone);
	...
	public static void menuCartAddItem(Book[] mBookList) {
		...
		*/
		...
		while (!quit) {
			...
			if (flag) {
				...
				if (str.toUpperCase().equals("Y")) {
					System.out.println(mBookList[numID][0] + " 도서가 장바구니에 추가되었습니다.");
					if(!isCartInBook(mBookList[numID][0])) {
	...
	public static void BookList(Book[] booklist) {
		booklist[0] = new Book("ISBN1234", "쉽게 배우는 JSP 웹프로그래밍", 27000);
